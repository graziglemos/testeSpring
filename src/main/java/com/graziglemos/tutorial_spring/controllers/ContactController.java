package com.graziglemos.tutorial_spring.controllers;
...
import com.graziglemos.tutorial_spring.models.services.ContactService;
...
public class ContactController {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		return contactService.findById(id)
				.map(record -> { contactService.deleteById(id);
